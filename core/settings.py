...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #esto hay que agregarlo luego de instalar whitenoise
...
DATABASES = {
    'default': {
        ...
        'HOST': env('DATABASE_HOST'),  # 👈 debe coincidir con el nombre del servicio
        'PORT': 5432
    }
}
